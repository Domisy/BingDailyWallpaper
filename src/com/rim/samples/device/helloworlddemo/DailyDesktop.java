...
public class DailyDesktop extends UiApplication implements SystemListener
{
    ...
    private static class AppScreen extends MainScreen 
    {
        ...
        public AppScreen(UiApplication app) {
            ...
            /*Bitmap background = Bitmap.getBitmapResource("img/greenBackground.png");
            Bitmap newImageBackground = new Bitmap(scaleWidth, scaleHeight);
            background.scaleInto(newImageBackground, Bitmap.FILTER_BILINEAR, Bitmap.SCALE_STRETCH); 
            BitmapField bmpFieldBackground = new BitmapField(newImageBackground);*/
            ...
            //int halfwayDown = (Display.getHeight() / 2) - (scaleHeight /2);
            
            //manager.add(bmpFieldBackground, 0, 0);
            //manager.add(bmpField, 0, halfwayDown);
            //add(manager);
            add(bmpField);
...
final class HelloWorldScreen extends MainScreen
{
    ...
    {        
    	...
    	//add(hfm);
   		...
   		checkField.setChecked(BingModel.retrieveState());
